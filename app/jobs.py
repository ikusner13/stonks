...
async def compute_regime_signal(weights: dict[str, float]):
    from .portfolio.decision_support import compute_regime_signal as compute

    return await compute(weights)
